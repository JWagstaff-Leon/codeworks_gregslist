...
{
    return `
    <form onsubmit="app.listingsController.submitForm('${car.id}')">
      ...
      <div class="mb-3 d-flex justify-content-between">
        ...
        <div class="mx-1 flex-grow-1">
          ...
          <input type="color" class="form-control h-100" name="color" id="color" aria-describedby="color" required value="${car.color}">
        </div>
      </div>
      <div class="mb-3">
        <div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">${car.id ? "Edit" : "Create"}</button>
      </div>
    </form>`
  }